...
namespace EpicToonFX
{
    public class ETFXProjectileScript : MonoBehaviour
    {
        ...
        {	
			...
			{
			    transform.rotation = Quaternion.LookRotation(GetComponent<Rigidbody>().velocity); // Sets rotation to look at _direction of movement
			}
            ...
            Vector3 direction = transform.GetComponent<Rigidbody>().velocity; // Gets the _direction of the projectile, used for collision detection
            ...
            if (Physics.SphereCast(transform.position, radius, direction, out hit, detectionDistance)) // Checks if collision will happen
            {
                ...
                //Component at [0] is that of the _parent i.e. this object (if there is any)
